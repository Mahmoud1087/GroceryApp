...
class Voice2 : AppCompatActivity() {
            ...
            connect.setOnClickListener(View.OnClickListener {
                ...
                try {
                    try {
                        ...
                        Toast.makeText(this@Voice2, e.localizedMessage, Toast.LENGTH_SHORT).show()
                    }
                } catch (e: Exception) {
    ...
    fun showDialog() {
        val alertDialogBuilder = MaterialAlertDialogBuilder(this@Voice2)
